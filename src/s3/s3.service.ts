import { DeleteObjectCommand, DeleteObjectCommandInput, ListBucketsCommand, PutObjectCommand, PutObjectCommandInput, S3Client, S3ServiceException } from "@aws-sdk/client-s3";
...
export class S3Service {
  ...
  async getPreSignedUrl(fileName: string, primaryPath: PrimaryPaths, expiresIn: number = 300) {
    ...
    return { url:this.removeCredentialFromUrl(url), key: imageName, method: "PUT", expiresIn: `${expiresIn}s` };
  }
